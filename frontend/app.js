    ...
    activeProjects.forEach(p => {
        ...
        topics.forEach(t => {
            ...
            topicDocs.forEach(d => {
                ...
                html += docTagsHtml;
                html += `<a href="${escapeHtml(d.url)}" target="_blank" rel="noopener" title="${escapeHtml(d.name)}">${escapeHtml(d.name)}</a>`;
...
(function () {
    ...
    resizer.addEventListener('mousedown', (e) => {
        ...
        function onUp() {
            ...
            localStorage.setItem('docsSidebarWidth', Math.round(sidebar.getBoundingClientRect().width));
        }
